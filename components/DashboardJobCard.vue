<template>
    <div class="bg-gray-50 translate-y-0 hover:bg-white border p-3 md:p-4 rounded-lg hover:border-blue-200 hover:-translate-y-1">
        <div class="flex flex-wrap justify-between items-center relative">
            <div class="w-full">
                ...
                <div class="w-full">
                    ...
                    <div class="flex flex-wrap md:space-x-4 py-1 mt-2 font-medium">
                        <div class="inline-flex items-center space-x-1 w-full md:w-auto">
            ...
            <div class="w-full md:absolute md:-top-4 md:right-2 md:w-64">
                <div class="flex justify-end items-center space-x-3 mt-4" v-if="isSaved">
                    <button 
